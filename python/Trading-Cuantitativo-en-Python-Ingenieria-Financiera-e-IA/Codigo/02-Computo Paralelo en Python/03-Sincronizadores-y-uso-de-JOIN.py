...
def operaciones_rango(limite_inferior: int, limite_superior: int, diccionario, clave, sincronizador) -> None:
    """
    Realiza una diversidad de operaciones a un grupo de números para obtener un valor único.
    """
    #Calcular.
    valor = 0
...
if __name__ == "__main__":
    ...
    #Mostar por consola en el diccionario
    print("\n\nObjeto de Memoria Compartida\n\n")
    print(dict_resultados.items())


# Recordatorio:
# - Los sincro9nizadores nos ayudan a veitar la corrupcionde nuestros datos y son perfectas herramientas para un orden en la ejecuci[on de tareas paralelas.
# - Los objetos de memoria compartida son útiles para compartir, agregar y modificar información
